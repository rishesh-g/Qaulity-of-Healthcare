...
class doctorSpider(scrapy.Spider):
    name = 'pune'
    page_num = 2
    start_urls = ['https://www.practo.com/pune/doctors?page=1']
    ...
    def parse(self, response):
        ...
        next_page = 'https://www.practo.com/pune/doctors?page=' + str(doctorSpider.page_num)
        if doctorSpider.page_num <= 568:
