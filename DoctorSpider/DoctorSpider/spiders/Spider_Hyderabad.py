...
class doctorSpider(scrapy.Spider):
    name = 'hyderabad'
    page_num = 2
    start_urls = ['https://www.practo.com/hyderabad/doctors?page=1']
    ...
    def parse(self, response):
        ...
        next_page = 'https://www.practo.com/hyderabad/doctors?page=' + str(doctorSpider.page_num)
        if doctorSpider.page_num <= 636:
