...
class doctorSpider(scrapy.Spider):
    name = 'delhi'
    page_num = 2
    start_urls = ['https://www.practo.com/delhi/doctors?page=1']
    ...
    def parse(self, response):
        ...
        next_page = 'https://www.practo.com/delhi/doctors?page=' + str(doctorSpider.page_num)
        if doctorSpider.page_num <= 822:
